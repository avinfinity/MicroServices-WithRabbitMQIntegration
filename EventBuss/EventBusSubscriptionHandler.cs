...
namespace EventBus
{
    public class EventBusSubscriptionHandler : IEventBusSubscriptionsHandler
    {
        ...
        public EventBusSubscriptionHandler()
        {
            ...
            where TH : IIntegrationEventHandler<T>
        {
            ...
            ValidateSubscription(typeof(TH), eventName, isDynamic: false);
        ...
        private void ValidateSubscription(Type handlerType, string eventName, bool isDynamic)
        {
        ...
        private Type DoFindSubscriptionToRemove(string eventName, Type handlerType)
        {
            ...
            return _handlers[eventName].SingleOrDefault(s => s.GetType() == handlerType);
        }
